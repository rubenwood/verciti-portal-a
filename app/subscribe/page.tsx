      ...
      <div className="dark grid items-center justify-items-center min-h-screen p-8 pb-20">
        ...
        <div className="flex flex-row space-x-4">
          <Image
            ...
            onClick={() =>
              window.open(
                "https://play.google.com/store/apps/details?id=com.verciti.edtechapp",
              )
            }
          />
          <Image
            ...
            onClick={() =>
              window.open(
                "https://apps.apple.com/us/app/verciti-skills-training/id6753941306",
              )
            }
          />
        </div>
        ...
        <iframe
          width={1905 / 2}
          height={824 / 2}
          src="https://www.youtube.com/embed/4hrPvsyTo9Q"
          title="OUT NOW | Verciti | The Platform Powering the Net Zero"
        ...
        <div className="mt-8 w-full max-w-6xl">
          <Tabs defaultValue="providers" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-6">
              ...
              <TabsTrigger value="employers">Employers & Industry</TabsTrigger>
            </TabsList>
